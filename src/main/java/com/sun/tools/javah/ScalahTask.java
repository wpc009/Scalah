...
import com.innoxyz.scalah.ScalaJNI;
import com.sun.tools.javac.code.Symbol.CompletionFailure;
import com.sun.tools.javac.main.CommandLine;

public class ScalahTask implements NativeHeaderTool.NativeHeaderTask{
    public final static void main(String[] args){
	ScalahTask t = new ScalahTask();
        int rc = t.run(args);
        System.exit(rc);
    }
    ...
    public class BadArgs extends Exception {
        ...
        BadArgs(String key, Object... args) {
            super(ScalahTask.this.getMessage(key, args));
            this.key = key;
            this.args = args;
        }
    ...
    static abstract class Option {
        ...
        abstract void process(ScalahTask task, String opt, String arg) throws BadArgs;
    ...
    static Option[] recognizedOptions = {
        new Option(true, "-o") {
            void process(ScalahTask task, String opt, String arg) {
    ...
    private Diagnostic<JavaFileObject> createDiagnostic(final String key, final Object... args) {
        return new Diagnostic<JavaFileObject>() {
            ...
            public String getMessage(Locale locale) {
                return ScalahTask.this.getMessage(locale, key, args);
            }
